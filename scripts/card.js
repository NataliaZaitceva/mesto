import { openPopup, popupImageMax, picturePopup, subtitlePopup } from './index.js';
export class Card {   
    ...
    _setEventListeners(){
     this._element.querySelector('.button_view_trash').addEventListener('click', () => {this._deleteCard()
    });
    this._element.querySelector('.button_view_like').addEventListener('click',  () => {this._likeCard()
   });
   this._photo.addEventListener('click',  () => {this._openImageMax()
        });
               }
